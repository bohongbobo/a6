...
#include "othello.h"
/// Othello function to make checkerboard.
/**
* The othello function. It includes the length and width and 
* after you put a piece, how does it change. And decided the black or
* the white turn.
*/
...
/**
* The top line.
* Using the number to describe col.
*/
...
/**
* The setting before start
* Two whit pieces and two black pieces
*/
...
/**
* Caluculate the piece
* To decide who win the game
*/
  int black = 0;
  int white = 0;
...
/**
* Finish the game
* There is no space to put piece
*/
...
/**
* Determine who win
* If white piece more than black, so white win.
* If black piece more than white, so black win.
*/
  if (black > white) {
    return last_mover();
  } else if (white > black) {
...
/**
* Computer move
* The best way that computer move to get more pieces
*/
  string r;
  string c;
  string move;
